...
MicroPython module: https://docs.micropython.org/en/v1.29.0/library/cryptolib.html

---
Module: 'cryptolib' on micropython-v1.29.0-rp2-RPI_PICO
"""

# MCU: {'mpy': 'v6.3', 'build': '', 'ver': '1.29.0', 'arch': 'armv6m', 'version': '1.29.0', 'port': 'rp2', 'board': 'RPI_PICO', 'family': 'micropython', 'board_id': 'RPI_PICO', 'variant': '', 'cpu': 'RP2040'}
# Stubber: v1.28.6
...
class aes:
    ...
    @overload
    def encrypt(self, in_buf: AnyReadableBuf, out_buf: _WB, /) -> _WB:
        """
        Encrypt *in_buf*. If no *out_buf* is given result is returned as a
        newly allocated `bytes` object. Otherwise, result is written into
        mutable buffer *out_buf*. *in_buf* and *out_buf* can also refer
    ...
    @overload
    def decrypt(self, in_buf: AnyReadableBuf, out_buf: _WB, /) -> _WB:
        """
        Like `encrypt()`, but for decryption.
        """
        ...
    ...
    @overload
    def __init__(self, key: AnyReadableBuf, mode: int, /) -> None:
        """
    ...
    @overload
    def __init__(self, key: AnyReadableBuf, mode: int, IV: AnyReadableBuf, /) -> None:
        """
        Initialize cipher object, suitable for encryption/decryption. Note:
        after initialization, cipher object can be use only either for
        encryption or decryption. Running decrypt() operation after encrypt()
